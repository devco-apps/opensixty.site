            ...
            <div className="xs:w-full md:w-1/2 lg:w-1/2 px-4 mb-12 lg:mb-0">
              <div className="text-left">
                ...
                <p className="text-gray-600 mb-8 text-base">
                  Construction is the process of planning, designing, and
                  building infrastructure such as residential homes, commercial
                  buildings, roads, bridges, and industrial facilities. It
                  involves the coordination of skilled labor.
                </p>
